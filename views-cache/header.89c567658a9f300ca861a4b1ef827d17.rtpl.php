...
<head>
  ...
  <!--Icone-->
   <link rel="icon" type="imagem/png" href="/res/admin/dist/img/store.png" />
  <!-- Bootstrap 3.3.6 -->
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="/res/admin/dist/img/usermarcos.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/res/admin/dist/img/usermarcos.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Marcos Araújo</span>
            </a>
            <ul class="dropdown-menu">
