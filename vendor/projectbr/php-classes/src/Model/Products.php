...
class Products extends Model {
    ...
    public function checkPhoto(){
        if (file_exists($_SERVER['DOCUMENT_ROOT']. DS . "res". DS .
            "site". DS . "img". DS . "products" . DS . $this->getidproduct() . ".jpg")){
    ...
    public function setPhoto($file) {
        ...
        $dist = $_SERVER['DOCUMENT_ROOT']. DS . "res". DS .
            "site". DS . "img". DS . "products" . DS . $this->getidproduct() . ".jpg";
    ...
    public function getFromURL($desurl) {
        ...
        $rows = $sql->select("SELECT * FROM tb_products WHERE 
                desurl = :desurl LIMIT 1", array(
                    ':desurl'=>$desurl
        ));
